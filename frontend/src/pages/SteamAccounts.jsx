  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold">Steam Accounts</h1>
            ...
            {currentAccounts.map((account) => (
              <Card key={account.id} className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <CardContent className="p-4">
                  ...
                  {/* Account Name */}
                  <h3 className="font-semibold text-lg mb-2 truncate" title={account.name}>
                    {account.name}
                  </h3>
                  ...
                  {account.games && account.games.length > 0 && (
                    <div className="mb-4">
                      <p className="text-xs text-muted-foreground mb-2">Games included:</p>
